...
@interface PHRecentsPersonPhoneHeaderSummaryView : _ABAddressBookBeginExclusiveRead <PHRecentsPersonHeaderSummaryView>
{
...
- (id)bottommostLabel;
- (id)initWithFrame:(struct CGRect)fp8 recentCall:(id)fp24 occurrenceDate:(id)fp28 type:(int)fp32 duration:(double)fp36 category:(int)fp44;
